...
def get_surface_albedo(wav_left, wav_right, solarzenithangle,uniformalbedoflag, uniformalbedo, frac_ocean,frac_old_snow, frac_new_snow, frac_desert, frac_tundra, mode, toreturn):
	"""
	...
	-frac_ocean, frac_old_snow, frac_new_snow, frac_desert, frac_tundra: Fraction of surface that is composed of each of these surface types. Should normalize (sum) to 1.
	...
	if uniformalbedoflag=='uniformalbedo':
		...
		total=frac_ocean+frac_old_snow+frac_new_snow+frac_desert+frac_tundra
		frac_ocean=frac_ocean/total
		frac_old_snow=frac_old_snow/total
		frac_new_snow=frac_new_snow/total
		frac_desert=frac_desert/total
		frac_tundra=frac_tundra/total
