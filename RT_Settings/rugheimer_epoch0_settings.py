...
###User-set parameters
########################
filename='rugheimer_earth_epoch0' #name of file to write output, plot to

#TOA input, and comparison file.
inputspectrafile='./LiteratureSpectra/rugheimer_epoch0_recomputed_A0.2.dat' #TOA Stellar Input and Reference Spectra for Comparison
