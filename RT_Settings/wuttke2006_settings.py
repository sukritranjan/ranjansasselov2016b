...
###User-set parameters
########################
filename='reproduce_wuttke2006' #name of file to write output, plot to

#TOA input, and comparison file.
inputspectrafile='./LiteratureSpectra/wuttke2006.dat' #TOA Stellar Input and Reference Spectra for Comparison

#Mixing ratio file
N_species=8 #how many gas species are in our model?
mr_profilefile='./MixingRatios/wuttke2006_mixingratios_v2.dat' #Mixing ratio file

#T/P Profile.
atmoprofilefile='./TPProfiles/wuttke2006_atmosphereprofile.dat' #T/P Profile File. File boundaries should match z_lower and z_upper
...
###Solar Zenith Angle
solarzenithangle=51.2*np.pi/180. #60 degrees (pi/3) used by Rugheimer et al in their paper.
...
uniformalbedo=0.00 #if adopting uniform albedo: what value?
