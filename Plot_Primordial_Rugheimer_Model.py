...
########################
importeddata=np.genfromtxt('./LiteratureSpectra/rugheimer_epoch0_recomputed_A0.2.dat', skip_header=1, skip_footer=0)
...
########################
importeddata=np.genfromtxt('./TwoStreamOutput/rugheimer_earth_epoch0.dat', skip_header=1, skip_footer=0)
...
########################
importeddata=np.genfromtxt('./TwoStreamOutput/rugheimer_earth_epoch0_rugheimerxcs.dat', skip_header=1, skip_footer=0)
